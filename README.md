...
📸 *See:* [`screenshots/fig1_vcs_waveform.md`](screenshots/fig1_vcs_waveform.md)
...
*For questions or collaboration, connect via [LinkedIn](https://www.linkedin.com) or raise an issue in this repository.*
